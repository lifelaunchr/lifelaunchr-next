...
| Version | Date | Notes |
|---------|------|-------|
| v1.1 | 2026-05-19 | Writing Hub production release. No new frontend code beyond v1.0.38. This tag marks the production deployment of the complete Writing Hub UI (all frontend work shipped in v1.0.38) alongside two backend bug fixes for the essays page — parents were getting 403 errors on the essays page due to tenant mismatch (see backend CLAUDE.md v1.1). See this file's v1.0.38 entry for the full Writing Hub UI description. See backend CLAUDE.md v1.1 for the deployment sequence (seed script, module SQL, per-student access SQL). |
